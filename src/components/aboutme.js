...
class About extends Component {
	render() {
		...
		return (
				<div> 
					<div className="w3-center" style={{margin:'50px'}}> 
						<Grid style={{paddingTop:'20px', paddingBottom:'20px'}}> 

							<Cell col={12}>

									
								<img style={{width: '10%', height:'100%' }} src={require('../images/logo.png')} />


							</Cell>
							<Cell col={12}>
									<div className="fancy-font" > 
									    <p style={{fontSize:'30px', color:'purple'}}> ABOUT US </p>	 
							...
							<Cell col={6}>
								...
								<div className="box" style={{textAlign:'left', color:'black'}} > 
