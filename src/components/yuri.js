					...
					<div style={{margin:'50px'}}> 
						<Grid style={{paddingTop:'20px', paddingBottom:'20px'}}> 
								...
								<Cell col={6}>
									...
									<img style={{width: '25%', height:'100%' }} src={('https://pre00.deviantart.net/0694/th/pre/f/2018/189/d/2/1_by_edalie_chan-dcgo1vg.png')} />

								</Cell>

								<Cell col={6}>
									<div className="box">
										<p> I think what I’m about to say from here is very important because it is one of the biggest reason why I am how I am today why the “Under the Sun” movement is so important to me. I came from a broken family. My  step father is a piece of shit that would beat me up as and when he pleased. I became depressed at a very young age, struggling with illnesses and drama that went on within my family. I had to choose between getting beat up or risk my step father hurting my mother. I started becoming suicidal. I was afraid of death and the thought of not knowing what’s to come after scared me.</p>
									</div>
						        </Cell>
								...
								<Cell col={6}>
									<div className="box"style={{color:'pink'}}>
										<p> I would have nightmares and would find myself weighing the pros and cons of if I took my life versus the pros and cons of taking my step father with me.. I didn’t want to die, I just didn’t have a reason to live. I didn’t feel like I lived a life. It felt more like I was simply an existence. I just, exist. That’s when blogging was starting to get popular.</p>
							        </div>
						        </Cell>
